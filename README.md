...
👥 2. Readers can browse ebooks, view details, purchase via Stripe, and track reading history.

✍️ 3. Writers can upload/manage their ebooks. They can publish/unpublish, edit, delete, and see sales history.

👨‍💻 4. Admin can manages users (role changes), all ebooks (publish/unpublish/delete), and all transactions

🔐 5. Authentication uses JWT with email/password and Google login.

📊 6. Dashboards are role-specific with CRUD operations, payment flows, and analytics.

💰 7. "Stripe" -in this project Stripe is used as payment Gateway for verified & Secure Payment Flow
